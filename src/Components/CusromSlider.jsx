...
//         <button
//           onClick={scrollLeft}
//           className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white text-blue-500 shadow-lg rounded-full p-3 hover:bg-blue-500 hover:text-white transition-all duration-300 z-10"
...
//               Manage users and courses effortlessly with a streamlined interface.
//             </p>
//           </div>
...
//         <button
//           onClick={scrollRight}
//           className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white text-blue-500 shadow-lg rounded-full p-3 hover:bg-blue-500 hover:text-white transition-all duration-300 z-10"
